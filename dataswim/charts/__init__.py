...
class Plot(Bokeh, Chartjs, Seaborn, Altair, Colors):
    ...
    def density_(self, label=None, style=None, opts=None):
        ...
        try:
            return self._get_chart(
                "density", style=style, opts=opts, label=label)
        except Exception as e:
    ...
    def dlinear_(self, label=None, style=None, opts=None):
        ...
        try:
            return self._get_chart(
                "dlinear", style=style, opts=opts, label=label)
        except Exception as e:
    ...
    def distrib_(self, label=None, style=None, opts=None):
        ...
        try:
            return self._get_chart(
                "distribution", style=style, opts=opts, label=label)
        except Exception as e:
    ...
    def line_num_(self, label=None, style=None, opts=None):
        ...
        try:
            return self._get_chart(
                "line_num", style=style, opts=opts, label=label)
        except Exception as e:
    ...
    def bar_num_(self, label=None, style=None, opts=None):
        ...
        try:
            return self._get_chart(
                "bar_num", style=style, opts=opts, label=label)
        except Exception as e:
            self.err(e, "Can not draw line and numbers chart")
            
    def point_num_(self, label=None, style=None, opts=None):
        """
        Get an Altair point + number marks chart
        """
        try:
            return self._get_chart(
                "point_num", style=style, opts=opts, label=label)
        except Exception as e:
            self.err(e, "Can not draw point and numbers chart")
